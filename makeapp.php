...
<body>
        <?php if (isset($_SESSION['username'])){
                if(isset($_POST['fromedit'])){
                        ...
                        $appdoctorname = $_POST['appdoctorname'];
                        $appdoctorsurname = $_POST['appdoctorsurname'];
                        $appdate = $_POST['appdate'];
                        $apphour = $_POST['apphour'];
                        ...
                        $timestamp1 = strtotime($_POST['appdate']." ".$_POST['apphour']);
                        ...
                        if($conn->query($sql) === TRUE){
                                ?>
                        <div class="links">
                            <a>Appointment Editted Successfully!</a><br><br>
                            <a href="/home.php">Continue</a>
                            <a href="/logout.php">Log Out</a>
                       </div>
                            <?php
