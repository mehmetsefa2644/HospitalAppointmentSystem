                ...
                if(isset($_POST['edit'])){ ?>
                        ...
                        <div class="links" style="position: absolute;
                                        ...
                                        <form action="adddoctor.php" method="post">
                                                Branch Name:
                                                <input type="text" name="doctornamefromedit">
                                                <input type="hidden" name="olddoctor" value="<?php echo $_POST['doctors']; ?>">
                                                <input type="submit" value="edit" name="fromedit">
                                        </form><br><br>
                                        <div style="font-size:25px">
                                        <a>Doctor to be editted:Doctor Name: <?php echo $_POST['doctors']; ?> </a>
                                        </div>
